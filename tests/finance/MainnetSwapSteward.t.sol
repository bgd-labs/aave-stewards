...
contract CancelSwapTest is MainnetSwapStewardTest {
    ...
    function test_successful() public {
        ...
        uint256 budgetBefore = steward.tokenBudget(
            AaveV3EthereumAssets.USDC_UNDERLYING
        );
    ...
    function test_successful_doesNotRemoveTwapSwapBalance() public {
        ...
        assertEq(
            ...
            balanceCollectorBefore + 500e6
        );

        uint256 balanceAfter = IERC20(AaveV3EthereumAssets.USDC_UNDERLYING)
...
contract CancelTWAPSwapTest is MainnetSwapStewardTest {
    ...
    function test_successful_cancelAfterPartExecuted() public {
        ...
        IERC20(AaveV3EthereumAssets.USDC_UNDERLYING).transferFrom(
            address(steward),
            COW_RELAYER,
            amount
        );
