...
import {ClinicStewardV3BaseTest} from "../../maintenance/ClinicStewardV3.t.sol";

/// forge-config: default.isolate = true
contract ClinicStewardV3GasTest is ClinicStewardV3BaseTest {
  function test_getBadDebtAmount_zero_users() public {
    _callGetBadDebtAmountWithNumberOfUsers(0);

    vm.snapshotGasLastCall("ClinicStewardV3", "function getBadDebtAmount: with 0 users");
  }

  function test_getBadDebtAmount_one_user() public {
    _callGetBadDebtAmountWithNumberOfUsers(1);

    vm.snapshotGasLastCall("ClinicStewardV3", "function getBadDebtAmount: with 1 user");
  }

  function test_getBadDebtAmount_two_users() public {
    _callGetBadDebtAmountWithNumberOfUsers(2);

    vm.snapshotGasLastCall("ClinicStewardV3", "function getBadDebtAmount: with 2 users");
  }
  ...
  function test_getBadDebtAmount_four_users() public {
    ...
    vm.snapshotGasLastCall("ClinicStewardV3", "function getBadDebtAmount: with 4 users");
  }

  function test_getBadDebtAmount_five_users() public {
    _callGetBadDebtAmountWithNumberOfUsers(5);

    vm.snapshotGasLastCall("ClinicStewardV3", "function getBadDebtAmount: with 5 users");
  }

  function test_getBadDebtAmount_six_users() public {
    _callGetBadDebtAmountWithNumberOfUsers(6);

    vm.snapshotGasLastCall("ClinicStewardV3", "function getBadDebtAmount: with 6 users");
  }

  function test_getDebtAmount_zero_users() public {
    _callGetDebtAmountWithNumberOfUsers(0);

    vm.snapshotGasLastCall("ClinicStewardV3", "function getDebtAmount: with 0 users");
  }

  function test_getDebtAmount_one_user() public {
    _callGetDebtAmountWithNumberOfUsers(1);

    vm.snapshotGasLastCall("ClinicStewardV3", "function getDebtAmount: with 1 user");
  }

  function test_getDebtAmount_two_users() public {
    _callGetBadDebtAmountWithNumberOfUsers(2);

    vm.snapshotGasLastCall("ClinicStewardV3", "function getDebtAmount: with 2 users");
  }
