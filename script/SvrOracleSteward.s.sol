...
import {SvrOracleSteward} from "../src/risk/SvrOracleSteward.sol";
...
library DeploySvrOracleSteward_Lib {
  ...
  function _deployMainnet() internal returns (SvrOracleSteward) {
    SvrOracleSteward.AssetOracle[] memory configs = new SvrOracleSteward.AssetOracle[](1);
    configs[0] = SvrOracleSteward.AssetOracle({
